const img = (seed) => `https://picsum.photos/seed/matestore-${seed}/900/900`
...
export const products = [
  // Mates Tradicionales
  {
    ...
    stock: 12,
    category: 'mates',
    image: img('mate-imperial-calabaza'),
  ...
  },
  {
    ...
    stock: 3,
    category: 'bombillas',
    image: img('bombilla-martin-fierro'),
  ...
  // Mates de Colección
  {
    ...
    stock: 3,
    category: 'mates',
    image: img('mate-asta-patagonica'),
